...
## Preface
I assume you already know a bit about YOOTheme pro by YOOtheme, Shopify
For First you Need:
- Shopify Account
- Shopify Api Token
- Shopify password
...
Please report issues using the [Github issue tool](https://github.com/jimikitarra/jiga-shopify/issues).

## About

JiGa Shopify Collect is a custom element for YOOtheme Pro developed by [YOOtheme](https://yootheme.com).
